...
Like other microservice transporters, you have <a href="/microservices/basics#客户端">several options</a> for creating a MQTT `ClientProxy` instance.
