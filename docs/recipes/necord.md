<!-- 此文件从 content/recipes\necord.md 自动生成，请勿直接修改此文件 -->
<!-- 生成时间: 2026-02-28T06:24:18.021Z -->
<!-- 源文件: content/recipes\necord.md -->
...
For a complete list of built-in option decorators, check out [this documentation](https://necord.org/interactions/slash-commands#选项).
